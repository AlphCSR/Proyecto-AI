...
plt.grid(True)
plt.savefig('assets/distribution_red.png')
...
plt.tight_layout()
plt.savefig('assets/correlation_matrix_red.png')
plt.close()
...
plt.tight_layout()
plt.savefig('assets/feature_importance_red.png')
plt.close()
...
joblib.dump(pipe, "src/regressors/rf_regressor_red.joblib")
print("\nModelo guardado como 'rf_regressor_red.joblib'")